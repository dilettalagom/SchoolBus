...
public class ComputeVendorsRank implements WindowFunction<Tuple3<Long, String, Tuple3<Long, Long, Long>>, String, Long, TimeWindow> {

    private final double WT = 0.3, WM = 0.5, WO = 0.2;
    private final int QUEUE_SIZE = 5;

    @Override
    public void apply(Long key, TimeWindow timeWindow, Iterable<Tuple3<Long, String, Tuple3<Long, Long, Long>>> iterable, Collector<String> out) throws Exception {
        ...
        for(Tuple3<Long, String, Tuple3<Long, Long, Long>> t : iterable){
