...
public class MonthWindow extends TumblingEventTimeWindows {
    ...
    public Collection<TimeWindow> assignWindows(Object element, long timestamp, WindowAssignerContext context) {
        ...
        long start = getStartOfMonth(lastTS);
        long end = getEndOfMonth(lastTS);

        return Collections.singletonList(new TimeWindow(start, end));
    }

    private long getStartOfMonth(LocalDateTime ldt) {
    ...
    private long getEndOfMonth(LocalDateTime ldt) {
