...
echo "alluxio.underfs.object.store.mount.shared.publicly=true" >> conf/alluxio-site.properties
echo "alluxio.user.file.writetype.default=ASYNC_THROUGH" >> conf/alluxio-site.properties
echo "alluxio.master.hostname=alluxio-master" >> conf/alluxio-site.properties
